...
--
-- Table structure for table `serial_template`
--

DROP TABLE IF EXISTS `serial_template`;
CREATE TABLE `serial_template` (
  `id` int(11) NOT NULL auto_increment,
  `name` varchar(25) collate utf8_spanish_ci NOT NULL default '',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

--
-- Dumping data for table `serial_template`
--
...
ALTER TABLE mm_i18n ADD `subserial_title` VARCHAR(150)  NOT NULL;
...
ALTER TABLE serial ADD `serial_template_id` INTEGER;
