...
$c = new Criteria();
$c->add(MmPeer::PUBLICDATE, date("Y-m-d", time() - (31 * 24 * 60 * 60)), Criteria::GREATER_EQUAL);
...
$text_log .= "Informacion de los objetos multimedia grabados este mes.\n";

$text_log .= "Numeros: ".count($mms)." objetos multimedia y ".sprintf('%.2f', FilePeer::doCountDurationLastMounth())." horas.\n\n";
...
$c = new Criteria();
$c->add(TranscodingPeer::TIMEEND, date("Y-m-d", time() - (31 * 24 * 60 * 60)), Criteria::GREATER_EQUAL);
