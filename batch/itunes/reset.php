...
if(count($argv) != 2){
  echo "ERROR: Necesito un parametro cualquera para BORRAR la base de datos \n";
  exit;
}
...
foreach($courses as $c){
  echo "BORRANDO $c \n";
  var_dump(itunes::DeleteCourse($c));
}
...
/*
  ...
  foreach(array('en', 'gl', 'en', 'xx') as $lid => $language){
*/