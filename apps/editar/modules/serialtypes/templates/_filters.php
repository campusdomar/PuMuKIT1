...
<?php echo form_remote_tag(array('update' => 'list_serialtypes', 'url' => 'serialtypes/list', 'script' => 'true' ), 'id=filter_serialtypes') ?>
  ...
  <ul class="tv_admin_actions">
    <li>
      <?php echo button_to_remote('reset', array('before' => '$("filter_serialtypes").reset();', 'update' => 'list_serialtypes', 'url' => 'serialtypes/list?filter=filter ', 'script' => 'true'), 'class=tv_admin_action_reset_filter') ?>
    </li>
    <li>
