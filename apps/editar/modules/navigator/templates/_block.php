...
<div class="thumbnails">
  <?php if ($type == 'folder'): ?>
    <?php echo link_to(image_tag('/images/admin/navigator/folder', array('alt' => $name, 'title' => $name, 'size' => '64x64')), 'navigator/'.$action.'?dir='.$current_path.'+'.$name) ?>
...
<div class="assetComment">
  ...
  <?php if ($action == 'index'): ?>
    <div id="edit_<?php echo $count ?>">
      <?php echo form_tag('navigator/rename', 'name=sf_asset_rename_form') ?>
        ...
        <?php echo submit_to_remote('rename', __('Rename', array(), 'navigator'), array(
          'url'      => 'navigator/rename',
          'update'   => 'block_'.$count,
          'script'   => true,
          ...
          <?php echo button_to_function(__('Cancel', array(), 'navigator'), "Element.hide('edit_".$count."');Element.show('view_".$count."')") ?>
      </form>
    </div>
    <?php echo javascript_tag("Element.hide('edit_".$count."');") ?>
    <div style="text-align:right">
      <?php echo $size ?>
      <?php echo link_to(image_tag('/images/admin/navigator/delete.png', array(
        'alt'   => __('Delete', array(), 'navigator'),
