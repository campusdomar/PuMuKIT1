<h3 class="cab_body_div"><img src="/images/admin/cab/config_ico.png"/> Perfiles</h3>
  ...
  <div id="tv_admin_content" >
    ...
    <div style="float:right; width:50%">
      <ul class="tv_admin_actions">
        <!-- Falta -->
        <li><?php echo button_to_function('nuevo', 'Modalbox.show("profiles/create", {title:"Editar Nuevo Rol", width:800}); return false;', array ('class' => 'tv_admin_action_create')) ?></li>
      </ul>
    </div>


    <select id="options_profiles" style="margin: 10px 0px; width: 33%" title="Acciones sobre elementos selecionados" onchange="window.change_select('profile', $('options_profiles'))">
