  ...
  <?php echo form_remote_tag(array(
    ...
    <div id="ok_login">
      <?php if($sf_request->getParameter('error') == 2):?>
        <span id="noSession" class="error" style="float:left; "><?php echo __('Sesi&oacute;n expirada')?>&nbsp;</span>
      <?php endif ?>
      <span id="noEstandar" class="error" style="display:none; float:left; "><?php echo __('No compatible con IE')?></span>
      <span id="noUser" class="error" style="display:none; float:left; "><?php echo __('ERROR de LOGIN')?></span>
      <?php echo submit_tag(__('OK'), 'class=ok')?>
    </div>
