...
?>
  ...
  <div id="pager_<?php echo $name?>" style="float:left;">
    <div style="float:left; margin:0em .5em;"><?php echo link_to_remote('&laquo;Anterior', array('update' => 'list_'.$name, 'url' => $name.'/list?page='.($page-1), 'script' => 'true'), $ver_anterior)  ?></div>
    ...
    <div style="float:left; margin:0em .5em;"><?php echo link_to_remote('Siguiente&raquo;', array('update'=> 'list_'.$name, 'url' => $name.'/list?page='.($page+1), 'script' => 'true'), $ver_siguiente) ?></div>
  </div>
