    ...
    <ul style="">
      ...
      <li class="normal">
        <?php echo link_to_remote(image_tag('admin/mbuttons/delete_inline.gif', 'alt=borrar title=borrar class=miniTag'). ' Borrar objeto multimedia', array(
                   'update' => 'mm_mms', 
                   'url' => 'virtualserial/delete?id='.$mm['id'], 
                   'script' => 'true', 
      ...
      <li class="normal">
        <?php echo link_to_remote(image_tag('admin/mbuttons/copy_inline.gif', 'alt=copiar title=copiar class=miniTag'). 'Clonar objeto multimedia', array(
                   'update' => 'list_mms', 
                   'url' => 'virtualserial/copy?id='.$mm['id'], 
                   'script' => 'true'))?>
      </li>
      <li class="normal">
        <?php echo m_link_to(image_tag('admin/mbuttons/info_inline.gif', 'alt=info title=info') . " Informacion del objeto multimedia", 'mms/info?id='.$mm['id'], array('title' => 'Info Archivo de Mm '.$mm['id']), array('width' => '800')) ?>
      </li>
