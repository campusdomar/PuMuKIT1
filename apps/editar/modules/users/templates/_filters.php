...
<?php echo form_remote_tag(array('update' => 'list_users', 'url' => 'users/list', 'script' => 'true' ), 'id=filter_users') ?>
  ...
  <ul class="tv_admin_actions">
    <li>
      <?php echo button_to_remote(__('reset'), array('before' => '$("filter_users").reset();', 'update' => 'list_users', 'url' => 'users/list?filter=filter ', 'script' => 'true'), 'class=tv_admin_action_reset_filter') ?>
    </li>
    <li>
