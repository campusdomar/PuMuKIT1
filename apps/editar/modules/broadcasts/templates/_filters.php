...
<?php echo form_remote_tag(array('update' => 'list_broadcasts', 'url' => 'broadcasts/list', 'script' => 'true' ), 'id=filter_broadcasts') ?>
  ...
  <ul class="tv_admin_actions">
    <li>
      <?php echo button_to_remote('reset', array('before' => '$("filter_broadcasts").reset();', 'update' => 'list_broadcasts', 'url' => 'broadcasts/list?filter=filter ', 'script' => 'true'), 'class=tv_admin_action_reset_filter') ?>
    </li>
    <li>
