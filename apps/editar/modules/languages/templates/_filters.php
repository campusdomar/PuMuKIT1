...
<?php echo form_remote_tag(array('update' => 'list_languages', 'url' => 'languages/list', 'script' => 'true' ), 'id=filter_languages') ?>
  ...
  <ul class="tv_admin_actions">
    <li>
      <?php echo button_to_remote('reset', array('before' => '$("filter_languages").reset();', 'update' => 'list_languages', 'url' => 'languages/list?filter=filter ', 'script' => 'true'), 'class=tv_admin_action_reset_filter') ?>
    </li>
    <li>
