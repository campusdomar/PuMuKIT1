...
try
{
  ...
  // compress output
  ob_start(sfConfig::get('sf_compressed') ? 'ob_gzhandler' : null); // (Andrés) Changed '' to null as http://trac.symfony-project.org/ticket/9970 to avoid php 5.4 Notice on CLI commands
}
catch (sfException $e)
{
  $e->printStackTrace();
