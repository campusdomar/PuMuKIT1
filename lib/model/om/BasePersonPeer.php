...
abstract class BasePersonPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Email', 'Web', 'Phone', ),
		BasePeer::TYPE_COLNAME => array (PersonPeer::ID, PersonPeer::NAME, PersonPeer::EMAIL, PersonPeer::WEB, PersonPeer::PHONE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'email', 'web', 'phone', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Email' => 2, 'Web' => 3, 'Phone' => 4, ),
		BasePeer::TYPE_COLNAME => array (PersonPeer::ID => 0, PersonPeer::NAME => 1, PersonPeer::EMAIL => 2, PersonPeer::WEB => 3, PersonPeer::PHONE => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'email' => 2, 'web' => 3, 'phone' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(PersonPeer::NAME);

		$criteria->addSelectColumn(PersonPeer::EMAIL);

		$criteria->addSelectColumn(PersonPeer::WEB);
    ...
    foreach (sfMixer::getCallables('BasePersonPeer:addDoSelectRS:addDoSelectRS') as $callable)
    {
  ...
  /**
   * Selects a collection of Person objects pre-filled with their i18n objects.
   *
  ...
  public static function doSelectWithI18n(Criteria $c, $culture = null, $con = null)
  {
    ...
    $startcol = (PersonPeer::NUM_COLUMNS - PersonPeer::NUM_LAZY_LOAD_COLUMNS) + 1;

    PersonI18nPeer::addSelectColumns($c);

    $c->addJoin(PersonPeer::ID, PersonI18nPeer::ID);
    $c->add(PersonI18nPeer::CULTURE, $culture);
    ...
    while($rs->next()) {
      ...
      $omClass = PersonI18nPeer::getOMClass($rs, $startcol);

      $cls = Propel::import($omClass);
      $obj2 = new $cls();
      $obj2->hydrate($rs, $startcol);

      $obj1->setPersonI18nForCulture($obj2, $culture);
      $obj2->setPerson($obj1);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, Connection $con)
	{
		...
		foreach($objects as $obj) {
			...
			include_once 'lib/model/PersonI18n.php';

			// delete related PersonI18n objects
			$c = new Criteria();
			
			$c->add(PersonI18nPeer::ID, $obj->getId());
			$affectedRows += PersonI18nPeer::doDelete($c, $con);
			...
			$c->add(MmPersonPeer::PERSON_ID, $obj->getId());
			...
			$c->add(MmTemplatePersonPeer::PERSON_ID, $obj->getId());
			$affectedRows += MmTemplatePersonPeer::doDelete($c, $con);

			include_once 'lib/model/PicPerson.php';

			// delete related PicPerson objects
			$c = new Criteria();
			
			$c->add(PicPersonPeer::OTHER_ID, $obj->getId());
			$affectedRows += PicPersonPeer::doDelete($c, $con);
		}
		return $affectedRows;
	}
	...
	public static function retrieveByPKWithI18n($pk, $culture = null, $con = null)
	{
		...
		$v = PersonPeer::doSelectWithI18n($criteria, $culture, $con);
	...
	public static function retrieveByPKsWithI18n($pks, $culture = null, $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria();
			$criteria->add(PersonPeer::ID, $pks, Criteria::IN);
			$objs = PersonPeer::doSelectWithI18n($criteria, $culture, $con);
		}
		return $objs;
	}
