...
abstract class BaseLanguagePeer {
	...
	const CLASS_DEFAULT = 'lib.model.Language';
	...
	const COD = 'language.COD';

	/** the column name for the DEFAULT_SEL field */
	const DEFAULT_SEL = 'language.DEFAULT_SEL';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (LanguagePeer::ID, LanguagePeer::COD, LanguagePeer::DEFAULT_SEL, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (LanguagePeer::ID => 0, LanguagePeer::COD => 1, LanguagePeer::DEFAULT_SEL => 2, ),
	...
	{
		include_once 'lib/model/map/LanguageMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.LanguageMapBuilder');
	}
	/**
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(LanguagePeer::COD);

		$criteria->addSelectColumn(LanguagePeer::DEFAULT_SEL);

	}

	const COUNT = 'COUNT(language.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT language.ID)';
    ...
    foreach (sfMixer::getCallables('BaseLanguagePeer:addDoSelectRS:addDoSelectRS') as $callable)
    {
  ...
  public static function doSelectWithI18n(Criteria $c, $culture = null, $con = null)
  {
    ...
    $c->add(LanguageI18nPeer::CULTURE, $culture);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, Connection $con)
	{
		...
		foreach($objects as $obj) {
			...
			include_once 'lib/model/LanguageI18n.php';
	...
	public static function retrieveByPKWithI18n($pk, $culture = null, $con = null)
	{
		...
		$v = LanguagePeer::doSelectWithI18n($criteria, $culture, $con);
	...
	public static function retrieveByPKsWithI18n($pks, $culture = null, $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria();
			$criteria->add(LanguagePeer::ID, $pks, Criteria::IN);
			$objs = LanguagePeer::doSelectWithI18n($criteria, $culture, $con);
		}
		return $objs;
	}
...
if (Propel::isInit()) {
	...
	require_once 'lib/model/map/LanguageMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.LanguageMapBuilder');
}
