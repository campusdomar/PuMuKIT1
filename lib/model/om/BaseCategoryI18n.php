...
/**
 * Base class that represents a row from the 'category_i18n' table.
 *
 * 
 *
...
abstract class BaseCategoryI18n extends BaseObject  implements Persistent {
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			return $startcol + 3; // 3 = CategoryI18nPeer::NUM_COLUMNS - CategoryI18nPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function getCategory($con = null)
	{
		if ($this->aCategory === null && ($this->id !== null)) {
			...
			/* The following can be used instead of the line above to
			   ...
			   never be used.
			   $obj = CategoryPeer::retrieveByPK($this->id, $con);
	...
	public function getCategoryWithI18n($con = null)
	{
		if ($this->aCategory === null && ($this->id !== null)) {
			...
			$this->aCategory = CategoryPeer::retrieveByPKWithI18n($this->id, sfContext::getInstance()->getUser()->getCulture(), $con);
			...
			/* The following can be used instead of the line above to
			   ...
			   As it can lead to a db query with many results that may
			   never be used.
			   $obj = CategoryPeer::retrieveByPKWithI18n($this->id, sfContext::getInstance()->getUser()->getCulture(), $con);
			   $obj->addCategorys($this);
			 */
		}
		return $this->aCategory;
