...
abstract class BaseUser extends BaseObject  implements Persistent {
	...
	public function setRoot($v)
	{
		...
		if ($this->root !== $v || $v === true) {
			$this->root = $v;
			$this->modifiedColumns[] = UserPeer::ROOT;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->root = $rs->getBoolean($startcol + 5);

			$this->user_type_id = $rs->getInt($startcol + 6);
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[6], $arr)) $this->setUserTypeId($arr[$keys[6]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(UserPeer::ROOT)) $criteria->add(UserPeer::ROOT, $this->root);
