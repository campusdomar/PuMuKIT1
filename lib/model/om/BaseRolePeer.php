...
abstract class BaseRolePeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Cod', 'Rank', 'Xml', 'Display', ),
		BasePeer::TYPE_COLNAME => array (RolePeer::ID, RolePeer::COD, RolePeer::RANK, RolePeer::XML, RolePeer::DISPLAY, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'cod', 'rank', 'xml', 'display', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Cod' => 1, 'Rank' => 2, 'Xml' => 3, 'Display' => 4, ),
		BasePeer::TYPE_COLNAME => array (RolePeer::ID => 0, RolePeer::COD => 1, RolePeer::RANK => 2, RolePeer::XML => 3, RolePeer::DISPLAY => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'cod' => 1, 'rank' => 2, 'xml' => 3, 'display' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(RolePeer::COD);

		$criteria->addSelectColumn(RolePeer::RANK);

		$criteria->addSelectColumn(RolePeer::XML);

		$criteria->addSelectColumn(RolePeer::DISPLAY);
    ...
    foreach (sfMixer::getCallables('BaseRolePeer:addDoSelectRS:addDoSelectRS') as $callable)
    {
  ...
  /**
   * Selects a collection of Role objects pre-filled with their i18n objects.
   *
  ...
  public static function doSelectWithI18n(Criteria $c, $culture = null, $con = null)
  {
    ...
    while($rs->next()) {
      ...
      $omClass = RoleI18nPeer::getOMClass($rs, $startcol);

      $cls = Propel::import($omClass);
      $obj2 = new $cls();
      $obj2->hydrate($rs, $startcol);

      $obj1->setRoleI18nForCulture($obj2, $culture);
      $obj2->setRole($obj1);
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->begin();
			$affectedRows += RolePeer::doOnDeleteCascade(new Criteria(), $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, Connection $con)
	{
		...
		foreach($objects as $obj) {
			...
			include_once 'lib/model/RoleI18n.php';

			// delete related RoleI18n objects
			$c = new Criteria();
			
			$c->add(RoleI18nPeer::ID, $obj->getId());
			$affectedRows += RoleI18nPeer::doDelete($c, $con);
		}
		return $affectedRows;
	}
	...
	public static function retrieveByPKWithI18n($pk, $culture = null, $con = null)
	{
		...
		$v = RolePeer::doSelectWithI18n($criteria, $culture, $con);
	...
	public static function retrieveByPKsWithI18n($pks, $culture = null, $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria();
			$criteria->add(RolePeer::ID, $pks, Criteria::IN);
			$objs = RolePeer::doSelectWithI18n($criteria, $culture, $con);
		}
		return $objs;
	}
