...
abstract class BasePicSerial extends BaseObject  implements Persistent {
	...
	public function getSerialWithI18n($con = null)
	{
		if ($this->aSerial === null && ($this->other_id !== null)) {
			...
			$this->aSerial = SerialPeer::retrieveByPKWithI18n($this->other_id, sfContext::getInstance()->getUser()->getCulture(), $con);
			...
			/* The following can be used instead of the line above to
			   ...
			   As it can lead to a db query with many results that may
			   never be used.
			   $obj = SerialPeer::retrieveByPKWithI18n($this->other_id, sfContext::getInstance()->getUser()->getCulture(), $con);
			   $obj->addSerials($this);
			 */
		}
		return $this->aSerial;
