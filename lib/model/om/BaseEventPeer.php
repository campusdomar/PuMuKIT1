...
abstract class BaseEventPeer {
	...
	/** the column name for the DIRECT_ID field */
	const DIRECT_ID = 'event.DIRECT_ID';
	...
	/** the column name for the CREATE_SERIAL field */
	const CREATE_SERIAL = 'event.CREATE_SERIAL';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'DirectId', 'Name', 'Place', 'Date', 'Duration', 'Display', 'CreateSerial', ),
		BasePeer::TYPE_COLNAME => array (EventPeer::ID, EventPeer::DIRECT_ID, EventPeer::NAME, EventPeer::PLACE, EventPeer::DATE, EventPeer::DURATION, EventPeer::DISPLAY, EventPeer::CREATE_SERIAL, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'direct_id', 'name', 'place', 'date', 'duration', 'display', 'create_serial', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'DirectId' => 1, 'Name' => 2, 'Place' => 3, 'Date' => 4, 'Duration' => 5, 'Display' => 6, 'CreateSerial' => 7, ),
		BasePeer::TYPE_COLNAME => array (EventPeer::ID => 0, EventPeer::DIRECT_ID => 1, EventPeer::NAME => 2, EventPeer::PLACE => 3, EventPeer::DATE => 4, EventPeer::DURATION => 5, EventPeer::DISPLAY => 6, EventPeer::CREATE_SERIAL => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'direct_id' => 1, 'name' => 2, 'place' => 3, 'date' => 4, 'duration' => 5, 'display' => 6, 'create_serial' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(EventPeer::DIRECT_ID);
		...
		$criteria->addSelectColumn(EventPeer::DURATION);

		$criteria->addSelectColumn(EventPeer::DISPLAY);

		$criteria->addSelectColumn(EventPeer::CREATE_SERIAL);
	...
	public static function doCountJoinDirect(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(EventPeer::DIRECT_ID, DirectPeer::ID);
	...
	/**
	 * Selects a collection of Event objects pre-filled with their Direct objects.
	 *
	...
	public static function doSelectJoinDirect(Criteria $c, $con = null)
	{
		...
		$c->addJoin(EventPeer::DIRECT_ID, DirectPeer::ID);
		...
		while($rs->next()) {
			...
			foreach($results as $temp_obj1) {
				...
				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					...
					$temp_obj2->addEvent($obj1); //CHECKME
					break;
				}
			}
			if ($newObject) {
				$obj2->initEvents();
				$obj2->addEvent($obj1); //CHECKME
			}
			$results[] = $obj1;
		}
		return $results;
    ...
    foreach (sfMixer::getCallables('BaseEventPeer:doInsert:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		$criteria->remove(EventPeer::ID); // remove pkey col since this table uses auto-increment
