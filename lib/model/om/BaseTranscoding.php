...
/**
 * Base class that represents a row from the 'transcoding' table.
 *
 * 
 *
 * @package    lib.model.om
 */
abstract class BaseTranscoding extends BaseObject  implements Persistent {
	...
	/**
	 * Collection to store aggregation of collTranscodingI18ns.
	 * @var        array
	 */
	protected $collTranscodingI18ns;

	/**
	 * The criteria used to select the current contents of collTranscodingI18ns.
	 * @var        Criteria
	 */
	protected $lastTranscodingI18nCriteria = null;
  ...
  protected $culture;
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = TranscodingPeer::ID;
		}
	...
	public function setMmId($v)
	{
		...
		if ($this->mm_id !== $v) {
			$this->mm_id = $v;
			$this->modifiedColumns[] = TranscodingPeer::MM_ID;
		}
	...
	public function setLanguageId($v)
	{
		...
		if ($this->language_id !== $v) {
			$this->language_id = $v;
			$this->modifiedColumns[] = TranscodingPeer::LANGUAGE_ID;
		}
	...
	public function setPerfilId($v)
	{
		...
		if ($this->perfil_id !== $v) {
			$this->perfil_id = $v;
			$this->modifiedColumns[] = TranscodingPeer::PERFIL_ID;
		}
	...
	public function setCpuId($v)
	{
		...
		if ($this->cpu_id !== $v) {
			$this->cpu_id = $v;
			$this->modifiedColumns[] = TranscodingPeer::CPU_ID;
		}
	...
	public function setUrl($v)
	{
		...
		if ($this->url !== $v) {
			$this->url = $v;
			$this->modifiedColumns[] = TranscodingPeer::URL;
		}
	...
	public function setStatusId($v)
	{
		...
		if ($this->status_id !== $v) {
			$this->status_id = $v;
			$this->modifiedColumns[] = TranscodingPeer::STATUS_ID;
		}
	...
	public function setPriority($v)
	{
		...
		if ($this->priority !== $v) {
			$this->priority = $v;
			$this->modifiedColumns[] = TranscodingPeer::PRIORITY;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = TranscodingPeer::NAME;
		}
	...
	public function setTimeini($v)
	{
		...
		if ($this->timeini !== $ts) {
			$this->timeini = $ts;
			$this->modifiedColumns[] = TranscodingPeer::TIMEINI;
		}
	...
	public function setTimestart($v)
	{
		...
		if ($this->timestart !== $ts) {
			$this->timestart = $ts;
			$this->modifiedColumns[] = TranscodingPeer::TIMESTART;
		}
	...
	public function setTimeend($v)
	{
		...
		if ($this->timeend !== $ts) {
			$this->timeend = $ts;
			$this->modifiedColumns[] = TranscodingPeer::TIMEEND;
		}
	...
	public function setPid($v)
	{
		...
		if ($this->pid !== $v) {
			$this->pid = $v;
			$this->modifiedColumns[] = TranscodingPeer::PID;
		}
	...
	public function setPathIni($v)
	{
		...
		if ($this->path_ini !== $v) {
			$this->path_ini = $v;
			$this->modifiedColumns[] = TranscodingPeer::PATH_INI;
		}
	...
	public function setPathEnd($v)
	{
		...
		if ($this->path_end !== $v) {
			$this->path_end = $v;
			$this->modifiedColumns[] = TranscodingPeer::PATH_END;
		}
	...
	public function setExtIni($v)
	{
		...
		if ($this->ext_ini !== $v) {
			$this->ext_ini = $v;
			$this->modifiedColumns[] = TranscodingPeer::EXT_INI;
		}
	...
	public function setExtEnd($v)
	{
		...
		if ($this->ext_end !== $v) {
			$this->ext_end = $v;
			$this->modifiedColumns[] = TranscodingPeer::EXT_END;
		}
	...
	public function setDuration($v)
	{
		...
		if ($this->duration !== $v || $v === 0) {
			$this->duration = $v;
			$this->modifiedColumns[] = TranscodingPeer::DURATION;
		}
	...
	public function setEmail($v)
	{
		...
		if ($this->email !== $v) {
			$this->email = $v;
			$this->modifiedColumns[] = TranscodingPeer::EMAIL;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			return $startcol + 20; // 20 = TranscodingPeer::NUM_COLUMNS - TranscodingPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating Transcoding object", $e);
		}
	}
    ...
    foreach (sfMixer::getCallables('BaseTranscoding:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			$con->begin();
			TranscodingPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseTranscoding:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseTranscoding:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseTranscoding:save:post') as $callable)
    {
	...
	protected function doSave($con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = TranscodingPeer::doInsert($this, $con);
					...
					$affectedRows += TranscodingPeer::doUpdate($this, $con);
				}
				$this->resetModified(); // [HL] After being saved an object is no longer 'modified'
			}

			if ($this->collTranscodingI18ns !== null) {
				foreach($this->collTranscodingI18ns as $referrerFK) {
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = TranscodingPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = TranscodingPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = TranscodingPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getMmId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TranscodingPeer::ID)) $criteria->add(TranscodingPeer::ID, $this->id);
		if ($this->isColumnModified(TranscodingPeer::MM_ID)) $criteria->add(TranscodingPeer::MM_ID, $this->mm_id);
		if ($this->isColumnModified(TranscodingPeer::LANGUAGE_ID)) $criteria->add(TranscodingPeer::LANGUAGE_ID, $this->language_id);
		if ($this->isColumnModified(TranscodingPeer::PERFIL_ID)) $criteria->add(TranscodingPeer::PERFIL_ID, $this->perfil_id);
		if ($this->isColumnModified(TranscodingPeer::CPU_ID)) $criteria->add(TranscodingPeer::CPU_ID, $this->cpu_id);
		if ($this->isColumnModified(TranscodingPeer::URL)) $criteria->add(TranscodingPeer::URL, $this->url);
		if ($this->isColumnModified(TranscodingPeer::STATUS_ID)) $criteria->add(TranscodingPeer::STATUS_ID, $this->status_id);
		if ($this->isColumnModified(TranscodingPeer::PRIORITY)) $criteria->add(TranscodingPeer::PRIORITY, $this->priority);
		if ($this->isColumnModified(TranscodingPeer::NAME)) $criteria->add(TranscodingPeer::NAME, $this->name);
		if ($this->isColumnModified(TranscodingPeer::TIMEINI)) $criteria->add(TranscodingPeer::TIMEINI, $this->timeini);
		if ($this->isColumnModified(TranscodingPeer::TIMESTART)) $criteria->add(TranscodingPeer::TIMESTART, $this->timestart);
		if ($this->isColumnModified(TranscodingPeer::TIMEEND)) $criteria->add(TranscodingPeer::TIMEEND, $this->timeend);
		if ($this->isColumnModified(TranscodingPeer::PID)) $criteria->add(TranscodingPeer::PID, $this->pid);
		if ($this->isColumnModified(TranscodingPeer::PATH_INI)) $criteria->add(TranscodingPeer::PATH_INI, $this->path_ini);
		if ($this->isColumnModified(TranscodingPeer::PATH_END)) $criteria->add(TranscodingPeer::PATH_END, $this->path_end);
		if ($this->isColumnModified(TranscodingPeer::EXT_INI)) $criteria->add(TranscodingPeer::EXT_INI, $this->ext_ini);
		if ($this->isColumnModified(TranscodingPeer::EXT_END)) $criteria->add(TranscodingPeer::EXT_END, $this->ext_end);
		if ($this->isColumnModified(TranscodingPeer::DURATION)) $criteria->add(TranscodingPeer::DURATION, $this->duration);
		if ($this->isColumnModified(TranscodingPeer::SIZE)) $criteria->add(TranscodingPeer::SIZE, $this->size);
		if ($this->isColumnModified(TranscodingPeer::EMAIL)) $criteria->add(TranscodingPeer::EMAIL, $this->email);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(TranscodingPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Transcoding (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		if ($deepCopy) {
			...
			foreach($this->getTranscodingI18ns() as $relObj) {
				$copyObj->addTranscodingI18n($relObj->copy($deepCopy));
			}
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Transcoding Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     TranscodingPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new TranscodingPeer();
		}
		return self::$peer;
	}
	...
	/**
	 * Temporary storage of collTranscodingI18ns to save a possible db hit in
	 * the event objects are add to the collection, but the
	 * complete collection is never requested.
	 * @return     void
	 */
	public function initTranscodingI18ns()
	{
		if ($this->collTranscodingI18ns === null) {
			$this->collTranscodingI18ns = array();
		}
	}
	 ...
	 * Otherwise if this Transcoding has previously
	 * been saved, it will retrieve related TranscodingI18ns from storage.
	 * If this Transcoding is new, it will return
	 ...
	 * @throws     PropelException
	 */
	public function getTranscodingI18ns($criteria = null, $con = null)
	{
		// include the Peer class
		include_once 'lib/model/om/BaseTranscodingI18nPeer.php';
		if ($criteria === null) {
		...
		if ($this->collTranscodingI18ns === null) {
			if ($this->isNew()) {
			   $this->collTranscodingI18ns = array();
				...
				$criteria->add(TranscodingI18nPeer::ID, $this->getId());

				TranscodingI18nPeer::addSelectColumns($criteria);
				$this->collTranscodingI18ns = TranscodingI18nPeer::doSelect($criteria, $con);
			}
		} else {
			...
			if (!$this->isNew()) {
				...
				TranscodingI18nPeer::addSelectColumns($criteria);
				if (!isset($this->lastTranscodingI18nCriteria) || !$this->lastTranscodingI18nCriteria->equals($criteria)) {
					$this->collTranscodingI18ns = TranscodingI18nPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastTranscodingI18nCriteria = $criteria;
		return $this->collTranscodingI18ns;
	}

	/**
	 * Returns the number of related TranscodingI18ns.
	 *
	 * @param      Criteria $criteria
	 ...
	 * @throws     PropelException
	 */
	public function countTranscodingI18ns($criteria = null, $distinct = false, $con = null)
	{
		// include the Peer class
		include_once 'lib/model/om/BaseTranscodingI18nPeer.php';
		if ($criteria === null) {
		...
		return TranscodingI18nPeer::doCount($criteria, $distinct, $con);
	}

	/**
	 * Method called to associate a TranscodingI18n object to this object
	 * through the TranscodingI18n foreign key attribute
	 *
	 * @param      TranscodingI18n $l TranscodingI18n
	 * @return     void
	 * @throws     PropelException
	 */
	public function addTranscodingI18n(TranscodingI18n $l)
	{
  ...
  {
    $obj = $this->getCurrentTranscodingI18n();
  ...
  {
    $this->getCurrentTranscodingI18n()->setDescription($value);
  }

  protected $current_i18n = array();

  public function getCurrentTranscodingI18n()
  {
    if (!isset($this->current_i18n[$this->culture]))
    {
      $obj = TranscodingI18nPeer::retrieveByPK($this->getId(), $this->culture);
      if ($obj)
      {
        $this->setTranscodingI18nForCulture($obj, $this->culture);
      }
      else
      {
        $this->setTranscodingI18nForCulture(new TranscodingI18n(), $this->culture);
  ...
  public function setTranscodingI18nForCulture($object, $culture)
  {
    $this->current_i18n[$culture] = $object;
    $this->addTranscodingI18n($object);
  }


  public function __call($method, $arguments)
  {
    if (!$callable = sfMixer::getCallable('BaseTranscoding:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseTranscoding::%s', $method));
    }
