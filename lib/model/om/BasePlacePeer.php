...
/**
 * Base static class for performing query and update operations on the 'place' table.
 *
 * 
 *
...
abstract class BasePlacePeer {
	...
	/** the column name for the COORGEO field */
	const COORGEO = 'place.COORGEO';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Coorgeo', 'Cod', ),
		BasePeer::TYPE_COLNAME => array (PlacePeer::ID, PlacePeer::COORGEO, PlacePeer::COD, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'coorgeo', 'cod', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Coorgeo' => 1, 'Cod' => 2, ),
		BasePeer::TYPE_COLNAME => array (PlacePeer::ID => 0, PlacePeer::COORGEO => 1, PlacePeer::COD => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'coorgeo' => 1, 'cod' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(PlacePeer::COORGEO);

		$criteria->addSelectColumn(PlacePeer::COD);
  ...
  public static function doSelectWithI18n(Criteria $c, $culture = null, $con = null)
  {
    ...
    while($rs->next()) {
      ...
      $omClass = PlaceI18nPeer::getOMClass($rs, $startcol);
    ...
    foreach (sfMixer::getCallables('BasePlacePeer:doInsert:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		$criteria->remove(PlacePeer::ID); // remove pkey col since this table uses auto-increment
	...
	/**
	 * Method to DELETE all rows from the place table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->begin();
			$affectedRows += PlacePeer::doOnDeleteCascade(new Criteria(), $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, Connection $con)
	{
		...
		foreach($objects as $obj) {
			...
			include_once 'lib/model/PlaceI18n.php';
	...
	public static function retrieveByPKWithI18n($pk, $culture = null, $con = null)
	{
		...
		$v = PlacePeer::doSelectWithI18n($criteria, $culture, $con);
	...
	public static function retrieveByPKsWithI18n($pks, $culture = null, $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria();
			$criteria->add(PlacePeer::ID, $pks, Criteria::IN);
			$objs = PlacePeer::doSelectWithI18n($criteria, $culture, $con);
		}
		return $objs;
	}
