...
abstract class BaseUserPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Login', 'Name', 'Passwd', 'Email', 'Root', 'UserTypeId', ),
		BasePeer::TYPE_COLNAME => array (UserPeer::ID, UserPeer::LOGIN, UserPeer::NAME, UserPeer::PASSWD, UserPeer::EMAIL, UserPeer::ROOT, UserPeer::USER_TYPE_ID, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'login', 'name', 'passwd', 'email', 'root', 'user_type_id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Login' => 1, 'Name' => 2, 'Passwd' => 3, 'Email' => 4, 'Root' => 5, 'UserTypeId' => 6, ),
		BasePeer::TYPE_COLNAME => array (UserPeer::ID => 0, UserPeer::LOGIN => 1, UserPeer::NAME => 2, UserPeer::PASSWD => 3, UserPeer::EMAIL => 4, UserPeer::ROOT => 5, UserPeer::USER_TYPE_ID => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'login' => 1, 'name' => 2, 'passwd' => 3, 'email' => 4, 'root' => 5, 'user_type_id' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(UserPeer::ROOT);
