...
abstract class BaseTemplate extends BaseObject  implements Persistent {
	...
	/**
	 * Collection to store aggregation of collTemplateI18ns.
	 * @var        array
	 */
	protected $collTemplateI18ns;

	/**
	 * The criteria used to select the current contents of collTemplateI18ns.
	 * @var        Criteria
	 */
	protected $lastTemplateI18nCriteria = null;
  ...
  protected $culture;
	...
	public function setUser($v)
	{
		...
		if ($this->user !== $v || $v === true) {
			$this->user = $v;
			$this->modifiedColumns[] = TemplatePeer::USER;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->user = $rs->getBoolean($startcol + 3);
			...
			return $startcol + 4; // 4 = TemplatePeer::NUM_COLUMNS - TemplatePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TemplatePeer::USER)) $criteria->add(TemplatePeer::USER, $this->user);
	...
	/**
	 * Temporary storage of collTemplateI18ns to save a possible db hit in
	 * the event objects are add to the collection, but the
	 * complete collection is never requested.
	 * @return     void
	 */
	public function initTemplateI18ns()
	{
		if ($this->collTemplateI18ns === null) {
			$this->collTemplateI18ns = array();
		}
	}
	 ...
	 * Otherwise if this Template has previously
	 * been saved, it will retrieve related TemplateI18ns from storage.
	 ...
	 * @throws     PropelException
	 */
	public function getTemplateI18ns($criteria = null, $con = null)
	{
		// include the Peer class
		include_once 'lib/model/om/BaseTemplateI18nPeer.php';
		if ($criteria === null) {
		...
		if ($this->collTemplateI18ns === null) {
			if ($this->isNew()) {
			   $this->collTemplateI18ns = array();
				...
				$criteria->add(TemplateI18nPeer::ID, $this->getId());

				TemplateI18nPeer::addSelectColumns($criteria);
				$this->collTemplateI18ns = TemplateI18nPeer::doSelect($criteria, $con);
			}
		} else {
			...
			if (!$this->isNew()) {
				...
				TemplateI18nPeer::addSelectColumns($criteria);
				if (!isset($this->lastTemplateI18nCriteria) || !$this->lastTemplateI18nCriteria->equals($criteria)) {
					$this->collTemplateI18ns = TemplateI18nPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastTemplateI18nCriteria = $criteria;
		return $this->collTemplateI18ns;
	}

	/**
	 * Returns the number of related TemplateI18ns.
	 *
	 * @param      Criteria $criteria
	 ...
	 * @throws     PropelException
	 */
	public function countTemplateI18ns($criteria = null, $distinct = false, $con = null)
	{
		// include the Peer class
		include_once 'lib/model/om/BaseTemplateI18nPeer.php';
		if ($criteria === null) {
		...
		return TemplateI18nPeer::doCount($criteria, $distinct, $con);
	}

	/**
	 * Method called to associate a TemplateI18n object to this object
	 * through the TemplateI18n foreign key attribute
	 *
	 * @param      TemplateI18n $l TemplateI18n
	 * @return     void
	 * @throws     PropelException
	 */
	public function addTemplateI18n(TemplateI18n $l)
	{
		$this->collTemplateI18ns[] = $l;
		$l->setTemplate($this);
	}
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			if ($this->collTemplateI18ns) {
				foreach ((array) $this->collTemplateI18ns as $o) {
  ...
  {
    $obj = $this->getCurrentTemplateI18n();
  ...
  {
    $this->getCurrentTemplateI18n()->setDescription($value);
  }
  ...
  {
    $this->getCurrentTemplateI18n()->setText($value);
  }

  protected $current_i18n = array();

  public function getCurrentTemplateI18n()
  {
    if (!isset($this->current_i18n[$this->culture]))
    {
      $obj = TemplateI18nPeer::retrieveByPK($this->getId(), $this->culture);
      if ($obj)
      {
        $this->setTemplateI18nForCulture($obj, $this->culture);
      }
      else
      {
        $this->setTemplateI18nForCulture(new TemplateI18n(), $this->culture);
  ...
  public function setTemplateI18nForCulture($object, $culture)
  {
    $this->current_i18n[$culture] = $object;
    $this->addTemplateI18n($object);
  }
