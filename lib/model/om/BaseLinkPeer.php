...
abstract class BaseLinkPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'MmId', 'Url', 'Rank', ),
		BasePeer::TYPE_COLNAME => array (LinkPeer::ID, LinkPeer::MM_ID, LinkPeer::URL, LinkPeer::RANK, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'mm_id', 'url', 'rank', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'MmId' => 1, 'Url' => 2, 'Rank' => 3, ),
		BasePeer::TYPE_COLNAME => array (LinkPeer::ID => 0, LinkPeer::MM_ID => 1, LinkPeer::URL => 2, LinkPeer::RANK => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'mm_id' => 1, 'url' => 2, 'rank' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(LinkPeer::MM_ID);

		$criteria->addSelectColumn(LinkPeer::URL);

		$criteria->addSelectColumn(LinkPeer::RANK);
	...
	public static function doCountJoinMm(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(LinkPeer::MM_ID, MmPeer::ID);
	...
	/**
	 * Selects a collection of Link objects pre-filled with their Mm objects.
	 *
	...
	public static function doSelectJoinMm(Criteria $c, $con = null)
	{
		...
		$c->addJoin(LinkPeer::MM_ID, MmPeer::ID);
		...
		while($rs->next()) {
			...
			foreach($results as $temp_obj1) {
				...
				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					...
					$temp_obj2->addLink($obj1); //CHECKME
					break;
				}
			}
			if ($newObject) {
				$obj2->initLinks();
				$obj2->addLink($obj1); //CHECKME
			}
			$results[] = $obj1;
		}
		return $results;
  ...
  /**
   * Selects a collection of Link objects pre-filled with their i18n objects.
   *
   * @return array Array of Link objects.
   * @throws PropelException Any exceptions caught during processing will be
   *     rethrown wrapped into a PropelException.
  ...
  public static function doSelectWithI18n(Criteria $c, $culture = null, $con = null)
  {
    ...
    while($rs->next()) {
      ...
      $omClass = LinkI18nPeer::getOMClass($rs, $startcol);

      $cls = Propel::import($omClass);
      $obj2 = new $cls();
      $obj2->hydrate($rs, $startcol);

      $obj1->setLinkI18nForCulture($obj2, $culture);
      $obj2->setLink($obj1);
    ...
    foreach (sfMixer::getCallables('BaseLinkPeer:doInsert:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		$criteria->remove(LinkPeer::ID); // remove pkey col since this table uses auto-increment
	...
	/**
	 * Method to DELETE all rows from the link table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->begin();
			$affectedRows += LinkPeer::doOnDeleteCascade(new Criteria(), $con);
	 ...
	 */
	 public static function doDelete($values, $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->begin();
			$affectedRows += LinkPeer::doOnDeleteCascade($criteria, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, Connection $con)
	{
		...
		$objects = LinkPeer::doSelect($criteria, $con);
		foreach($objects as $obj) {


			include_once 'lib/model/LinkI18n.php';

			// delete related LinkI18n objects
			$c = new Criteria();
			
			$c->add(LinkI18nPeer::ID, $obj->getId());
			$affectedRows += LinkI18nPeer::doDelete($c, $con);
		}
		return $affectedRows;
	}
	...
	public static function retrieveByPKWithI18n($pk, $culture = null, $con = null)
	{
		...
		$v = LinkPeer::doSelectWithI18n($criteria, $culture, $con);
	...
	public static function retrieveByPKsWithI18n($pks, $culture = null, $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria();
			$criteria->add(LinkPeer::ID, $pks, Criteria::IN);
			$objs = LinkPeer::doSelectWithI18n($criteria, $culture, $con);
		}
		return $objs;
	}
