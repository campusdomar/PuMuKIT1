...
abstract class BaseTemplatePeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Type', 'User', ),
		BasePeer::TYPE_COLNAME => array (TemplatePeer::ID, TemplatePeer::NAME, TemplatePeer::TYPE, TemplatePeer::USER, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'type', 'user', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Type' => 2, 'User' => 3, ),
		BasePeer::TYPE_COLNAME => array (TemplatePeer::ID => 0, TemplatePeer::NAME => 1, TemplatePeer::TYPE => 2, TemplatePeer::USER => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'type' => 2, 'user' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(TemplatePeer::USER);
  ...
  /**
   * Selects a collection of Template objects pre-filled with their i18n objects.
   *
  ...
  public static function doSelectWithI18n(Criteria $c, $culture = null, $con = null)
  {
    ...
    $c->addJoin(TemplatePeer::ID, TemplateI18nPeer::ID);
    $c->add(TemplateI18nPeer::CULTURE, $culture);
    ...
    while($rs->next()) {
      ...
      $omClass = TemplateI18nPeer::getOMClass($rs, $startcol);

      $cls = Propel::import($omClass);
      $obj2 = new $cls();
      $obj2->hydrate($rs, $startcol);

      $obj1->setTemplateI18nForCulture($obj2, $culture);
      $obj2->setTemplate($obj1);
	...
	/**
	 * Method perform an INSERT on the database, given a Template or Criteria object.
	 *
    ...
    foreach (sfMixer::getCallables('BaseTemplatePeer:doInsert:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		$criteria->remove(TemplatePeer::ID); // remove pkey col since this table uses auto-increment
	...
	/**
	 * Method perform an UPDATE on the database, given a Template or Criteria object.
	 *
	...
	/**
	 * Method to DELETE all rows from the template table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a Template or Criteria object OR a primary key value.
	 *
	...
	protected static function doOnDeleteCascade(Criteria $criteria, Connection $con)
	{
		...
		foreach($objects as $obj) {
			...
			include_once 'lib/model/TemplateI18n.php';

			// delete related TemplateI18n objects
			$c = new Criteria();
			
			$c->add(TemplateI18nPeer::ID, $obj->getId());
			$affectedRows += TemplateI18nPeer::doDelete($c, $con);
		}
		return $affectedRows;
	}
	...
	public static function retrieveByPKWithI18n($pk, $culture = null, $con = null)
	{
		...
		$v = TemplatePeer::doSelectWithI18n($criteria, $culture, $con);
	...
	public static function retrieveByPKsWithI18n($pks, $culture = null, $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria();
			$criteria->add(TemplatePeer::ID, $pks, Criteria::IN);
			$objs = TemplatePeer::doSelectWithI18n($criteria, $culture, $con);
		}
		return $objs;
	}
