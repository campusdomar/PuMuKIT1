...
abstract class BaseMaterialPeer {
	...
	const MM_ID = 'material.MM_ID';

	/** the column name for the URL field */
	const URL = 'material.URL';

	/** the column name for the RANK field */
	const RANK = 'material.RANK';

	/** the column name for the MAT_TYPE_ID field */
	const MAT_TYPE_ID = 'material.MAT_TYPE_ID';
	...
	{
		include_once 'lib/model/map/MaterialMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.MaterialMapBuilder');
	}
	/**
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(MaterialPeer::MM_ID);

		$criteria->addSelectColumn(MaterialPeer::URL);

		$criteria->addSelectColumn(MaterialPeer::RANK);

		$criteria->addSelectColumn(MaterialPeer::MAT_TYPE_ID);
    ...
    foreach (sfMixer::getCallables('BaseMaterialPeer:addDoSelectRS:addDoSelectRS') as $callable)
    {
      call_user_func($callable, 'BaseMaterialPeer', $criteria, $con);
    }
	...
	public static function doCountJoinMm(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(MaterialPeer::MM_ID, MmPeer::ID);
	...
	public static function doCountJoinMatType(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(MaterialPeer::MAT_TYPE_ID, MatTypePeer::ID);
	...
	/**
	 * Selects a collection of Material objects pre-filled with their Mm objects.
	 *
	...
	/**
	 * Selects a collection of Material objects pre-filled with their MatType objects.
	 *
	 * @return     array Array of Material objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	...
	public static function doSelectJoinMatType(Criteria $c, $con = null)
	{
		...
		$c->addJoin(MaterialPeer::MAT_TYPE_ID, MatTypePeer::ID);
		$rs = BasePeer::doSelect($c, $con);
		$results = array();
	...
	/**
	 * Selects a collection of Material objects pre-filled with all related objects except Mm.
	 *
	 * @return     array Array of Material objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	...
	/**
	 * Selects a collection of Material objects pre-filled with all related objects except MatType.
	 *
	 * @return     array Array of Material objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
  ...
  /**
   * Selects a collection of Material objects pre-filled with their i18n objects.
   *
   * @return array Array of Material objects.
   * @throws PropelException Any exceptions caught during processing will be
   *     rethrown wrapped into a PropelException.
  ...
  public static function doSelectWithI18n(Criteria $c, $culture = null, $con = null)
  {
    ...
    while($rs->next()) {
      ...
      $omClass = MaterialI18nPeer::getOMClass($rs, $startcol);

      $cls = Propel::import($omClass);
      $obj2 = new $cls();
      $obj2->hydrate($rs, $startcol);

      $obj1->setMaterialI18nForCulture($obj2, $culture);
      $obj2->setMaterial($obj1);
    ...
    foreach (sfMixer::getCallables('BaseMaterialPeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseMaterialPeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
    ...
    foreach (sfMixer::getCallables('BaseMaterialPeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BaseMaterialPeer', $values, $con, $pk);
    }
    ...
    foreach (sfMixer::getCallables('BaseMaterialPeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseMaterialPeer', $values, $con);
      if (false !== $ret)
      {
    ...
    foreach (sfMixer::getCallables('BaseMaterialPeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BaseMaterialPeer', $values, $con, $ret);
    }
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->begin();
			$affectedRows += MaterialPeer::doOnDeleteCascade(new Criteria(), $con);
	 ...
	 */
	 public static function doDelete($values, $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->begin();
			$affectedRows += MaterialPeer::doOnDeleteCascade($criteria, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, Connection $con)
	{
		...
		foreach($objects as $obj) {
			...
			include_once 'lib/model/MaterialI18n.php';

			// delete related MaterialI18n objects
			$c = new Criteria();
			
			$c->add(MaterialI18nPeer::ID, $obj->getId());
			$affectedRows += MaterialI18nPeer::doDelete($c, $con);
		}
		return $affectedRows;
	}
	...
	public static function doValidate(Material $obj, $cols = null)
	{
		...
		$res =  BasePeer::doValidate(MaterialPeer::DATABASE_NAME, MaterialPeer::TABLE_NAME, $columns);
    if ($res !== true) {
        $request = sfContext::getInstance()->getRequest();
        foreach ($res as $failed) {
            $col = MaterialPeer::translateFieldname($failed->getColumn(), BasePeer::TYPE_COLNAME, BasePeer::TYPE_PHPNAME);
	...
	public static function retrieveByPKWithI18n($pk, $culture = null, $con = null)
	{
		...
		$v = MaterialPeer::doSelectWithI18n($criteria, $culture, $con);
	...
	public static function retrieveByPKsWithI18n($pks, $culture = null, $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria();
			$criteria->add(MaterialPeer::ID, $pks, Criteria::IN);
			$objs = MaterialPeer::doSelectWithI18n($criteria, $culture, $con);
		}
		return $objs;
	}
...
if (Propel::isInit()) {
	...
	require_once 'lib/model/map/MaterialMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.MaterialMapBuilder');
}
