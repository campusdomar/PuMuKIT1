...
/**
 * Subclass for performing query and update operations on the 'pic_person' table.
 *
 *
 ...
 * @package lib.model
 */ 
class PicPersonPeer extends BasePicPersonPeer
{
  /**
  ...
  {
    if ($values instanceof PicPerson){
      $pic = $values->getPic();
