...
/**
 * This class adds structure of 'mm_i18n' table to 'propel' DatabaseMap object.
 *
 *
 *
 ...
 */
class MmI18nMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.MmI18nMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('mm_i18n');
		$tMap->setPhpName('MmI18n');
