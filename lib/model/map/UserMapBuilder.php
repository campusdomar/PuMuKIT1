...
class UserMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('LOGIN', 'Login', 'string', CreoleTypes::VARCHAR, true, 100);

		$tMap->addColumn('NAME', 'Name', 'string', CreoleTypes::VARCHAR, false, 250);

		$tMap->addColumn('PASSWD', 'Passwd', 'string', CreoleTypes::CHAR, true, 8);

		$tMap->addColumn('EMAIL', 'Email', 'string', CreoleTypes::VARCHAR, false, 30);

		$tMap->addColumn('ROOT', 'Root', 'boolean', CreoleTypes::BOOLEAN, true, null);

		$tMap->addColumn('USER_TYPE_ID', 'UserTypeId', 'int', CreoleTypes::INTEGER, true, null);
