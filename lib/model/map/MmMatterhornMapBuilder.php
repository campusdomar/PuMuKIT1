...
/**
 * This class adds structure of 'mm_matterhorn' table to 'propel' DatabaseMap object.
 *
 *
 *
 ...
 */
class MmMatterhornMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.MmMatterhornMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('mm_matterhorn');
		$tMap->setPhpName('MmMatterhorn');

		$tMap->setUseIdGenerator(false);

		$tMap->addForeignPrimaryKey('ID', 'Id', 'int' , CreoleTypes::INTEGER, 'mm', 'ID', true, null);

		$tMap->addColumn('MH_ID', 'MhId', 'string', CreoleTypes::VARCHAR, true, 255);

		$tMap->addColumn('CREATED_AT', 'CreatedAt', 'int', CreoleTypes::TIMESTAMP, false, null);

		$tMap->addColumn('PLAYER_URL', 'PlayerUrl', 'string', CreoleTypes::VARCHAR, true, 255);
		...
		$tMap->addColumn('INVERT', 'Invert', 'boolean', CreoleTypes::BOOLEAN, true, null);

	} // doBuild()

} // MmMatterhornMapBuilder
