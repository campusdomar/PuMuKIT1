...
/**
 * This class adds structure of 'transcoding' table to 'propel' DatabaseMap object.
 *
 *
 *
 ...
 */
class TranscodingMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.TranscodingMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('transcoding');
		$tMap->setPhpName('Transcoding');
		...
		$tMap->addColumn('EXT_INI', 'ExtIni', 'string', CreoleTypes::VARCHAR, true, 6);

		$tMap->addColumn('EXT_END', 'ExtEnd', 'string', CreoleTypes::VARCHAR, true, 6);
