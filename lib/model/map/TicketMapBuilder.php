...
/**
 * This class adds structure of 'ticket' table to 'propel' DatabaseMap object.
 *
 *
 *
...
class TicketMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('PATH', 'Path', 'string', CreoleTypes::VARCHAR, true, 250);

		$tMap->addColumn('URL', 'Url', 'string', CreoleTypes::VARCHAR, true, 250);

		$tMap->addColumn('DATE', 'Date', 'int', CreoleTypes::TIMESTAMP, true, null);

		$tMap->addColumn('END', 'End', 'int', CreoleTypes::TIMESTAMP, true, null);
