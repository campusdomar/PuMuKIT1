...
/**
 * This class adds structure of 'pub_channel' table to 'propel' DatabaseMap object.
 *
 *
 *
 ...
 */
class PubChannelMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.PubChannelMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('pub_channel');
		$tMap->setPhpName('PubChannel');
