...
/**
 * This class adds structure of 'mm_person' table to 'propel' DatabaseMap object.
 *
 *
 *
 ...
 */
class MmPersonMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.MmPersonMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('mm_person');
		$tMap->setPhpName('MmPerson');
