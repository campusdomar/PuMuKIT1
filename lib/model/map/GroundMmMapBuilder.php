...
/**
 * This class adds structure of 'ground_mm' table to 'propel' DatabaseMap object.
 *
 *
 *
 ...
 */
class GroundMmMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.GroundMmMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('ground_mm');
		$tMap->setPhpName('GroundMm');
