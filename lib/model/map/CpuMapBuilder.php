...
/**
 * This class adds structure of 'cpu' table to 'propel' DatabaseMap object.
 *
 *
 *
...
class CpuMapBuilder {
	 ...
	 */
	const CLASS_NAME = 'lib.model.map.CpuMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('MAX', 'Max', 'int', CreoleTypes::INTEGER, true, null);

		$tMap->addColumn('MIN', 'Min', 'int', CreoleTypes::INTEGER, true, null);
