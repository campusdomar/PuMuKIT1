...
/**
 * This class adds structure of 'mm_template' table to 'propel' DatabaseMap object.
 *
 *
 *
 ...
 */
class MmTemplateMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.MmTemplateMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('mm_template');
		$tMap->setPhpName('MmTemplate');
