...
# PuMuKIT User and Administration Manual
...
2. <a href="#user">PuMuKIT User Manual</a>

    2.1. <a href="#import">Content Import</a>

    2.1.1. <a href="#mono">Manual import of mono-stream content</a>
    ...
    2.2.2.5.1. <a href="#down">Download a master and publishing copy of a mono-stream video </a>
...
3. <a href="#annex">Annex</a>
    ...
    3.1. <a href="#broadcast">Broadcasting indicators</a>
...
-   **BACKEND**: Private administration portal where the database multimedia contents are catalogued and published. It also allows you to modify the configuration and appearance of the Web portal.
...
-   **Cataloguer**: he is in charge of administrating the series and multimedia objects employed as sources in the application of publication.
...
-   **ARCA:** The second publication mode. This data stream format RSS-ARCA generated by PuMuKIT allows that the database with all the audio-visual contents of our institution join a central database, the ARCA server.

# <a name="user">2. PuMuKIT User Manual</a>

## <a name="import"> 2.1. Content Import</a>

### <a name="mono"> 2.1.1. Manual import of mono-stream content</a>
...
-   **STEP I**: The wizard will show you a pop-up window to complete the metadata title and subtitle of the series that will contain the new multimedia object. If the wizard is run from within an existing series this step will not be displayed and the new media object is stored in said series.

![](images/image5.jpg)

-   **STEP II**: A second window to complete the metadata title, subtitle, description of new multimedia object and the title of subseries.

![](images/image6.jpg)

-   **STEP III**: Finally, a third window to complete technical metadata about the publication of the video. The metadata to complete are:

    -   *Master*: Quality video master; you can store a copy of the original video to catalog with "COPY" or compress it a bit using "H264". If the video takes up much space you should use "H264".

    -   *Publication Channels*: Multimedia channels where newly created object will be published: Web TV, iTunes, Youtube…

    -   *Priority*: Priority of transcodification. It is used to set the priority of the video in the transcode queue.
